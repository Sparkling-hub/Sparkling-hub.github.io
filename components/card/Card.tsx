...
const Card: React.FC = () => {
  ...
  return (
    ...
    drop-shadow-[0_3px_4px_rgba(0,0,0,0.23)] justify-center relative lg:absolute w-full bg-[#B0D311] duration-300 rounded-3xl ease-out  transition-height  ${isVisible ? 'opacity-100 h-[100%] top-[0%] ' : '100 h-[100%] top-[0%]'}`} >
